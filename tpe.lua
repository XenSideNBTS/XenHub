local Library = loadstring(Game:HttpGet("https://raw.githubusercontent.com/FoXEY747/Library-UI/main/Library"))()

local Window = Library:NewWindow("TPE")

local Main = Window:NewSection("Main")
local Credits = Window:NewSection("Credits")


Main:CreateButton("Walk", function()
...
Main:CreateButton("Teacher Chiar", function()
...
Main:CreateButton("Class", function()
...
Main:CreateButton("Ground", function()
...
Main:CreateButton("Toilet", function()
...
Credits:CreateButton("Db#2050", function()
print("The Original TPE Script Made By Db#2050")
end)
